...
* Map IAM roles and policies to the internship project architecture (Cognito, EC2, Lambda, S3, and related services).
* Continue implementing the internship project with least-privilege security aligned to the architecture diagram.
...
| 5 | Continue internship project – secure deployment:<br>- Attach permission boundaries and refined policies to project roles.<br>- Verify WAF → CloudFront → Amplify → Cognito → ALB → EC2 flow with correct IAM trust.<br>- Test API and storage access from application components. | 18/06/2026 | 18/06/2026 | — |
| 6 | Continue internship project – integration and review:<br>- Harden Lambda and AI pipeline roles (SQS, Rekognition, SageMaker) per architecture.<br>- Review CloudWatch and Secrets Manager access for observability and credentials.<br>- Document IAM decisions against the architecture diagram. | 19/06/2026 | 20/06/2026 | — |
...
* **Internship project:** Deployed and validated project components with boundary-aware, conditional IAM policies.
